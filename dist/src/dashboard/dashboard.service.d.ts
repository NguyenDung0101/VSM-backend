...
export declare class DashboardService {
    ...
    getDashboardStats(userRole: Role, query?: any): Promise<{
        overview: {
            users: {
                total: number;
                byRole: {
    ...
    private getPostStats;
    private getRegistrationStats;
    private getRecentActivity;
    private getMonthlyData;
    getDetailedEventStats(userRole: Role, eventId?: string): Promise<{
        event: {
            id: string;
            name: string;
            date: Date;
